...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    async def get_(
        ...
        *,
        ...
        result = await db.execute(
            select(self.model).where(self.model.id == pk),  # pyright: ignore[reportAttributeAccessIssue, reportUnknownArgumentType]
        )
    ...
    async def delete_(
        ...
        *,
        pk: str | None = None,
        func: Callable | None = None,  # pyright: ignore[reportMissingTypeArgument, reportUnknownParameterType]
    ) -> int:
        ...
        result = await db.execute(
            delete(self.model).where(
                self.model.id == pk if func is None else func(),  # pyright: ignore[reportAttributeAccessIssue, reportUnknownArgumentType]
            ),
        )
